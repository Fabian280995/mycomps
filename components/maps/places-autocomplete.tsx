...
const PlacesAutocomplete = ({
  ...
  return (
    <div
      className="bg-white rounded-full shadow-sm border relative
    flex items-center mx-4 sm:px-0 sm:w-2/3 lg:w-1/2 xl:w-1/3 sm:mx-auto"
    >
      <input
        value={value}
      ...
      {status === "OK" && (
        <motion.ul
          ...
          className="absolute top-full left-0 w-full bg-white border shadow-lg mt-2 rounded-3xl 
